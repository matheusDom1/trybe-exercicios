...
const addTech = (evento) => {
    const classT = document.querySelector('.tech');
    classT.classList.remove('tech');
    classT.classList.add('tech');
}
...
input.addEventListener('input', (evento) => {
    const classT = document.querySelector('.tech');
    classT.innerText = evento.target.value;
});
...
myWebpage.addEventListener('dblclick', () =>{
    window.location.replace('matheusdom1.github.io');
});
